...
from jeeez import Damn1

__CHANNEL_USERNAME__ = "DAMN"
__GROUP_USERNAME__   = "DAMN"
...
def banner(console):
    ...
    brand_name = figlet_format('DEYMN!', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @DAMN ')) 
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Increase Money           50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{02}: Increase Coins           50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{03}: King Rank                50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{04}: Change ID                50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{05}: Change Name              50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{06}: Change Name (Rainbow)    50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{07}: Number Plates            50K'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{10}: Delete Friends           50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{11}: Unlock Paid Cars         50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: Unlock all Cars          50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Unlock all Cars Siren    50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Unlock w16 Engine        50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Unlock All Horns         50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Unlock Disable Damage    50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: Unlock Unlimited Fuel    50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: Unlock House 3           50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: Unlock Smoke             50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Unlock Wheels            50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Unlock Animations        50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Unlock Equipaments M     50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{23}: Unlock Equipaments F     50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{24}: Change Race Wins         50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{25}: Change Race Loses        50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{26}: Clone Account            50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{27}: Glitch Car               50K'))
            print(Colorate.Horizontal(Colors.rainbow, '{28}: Custom Angle             50K'))
